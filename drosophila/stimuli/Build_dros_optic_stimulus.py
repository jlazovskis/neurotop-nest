...
D=pickle.load(open('/home/jason/Documents/neurotop-nest/structure/dros_bodyId2vertex.pkl','rb'))
...
np.save(root+'stimuli/drosophila_optic_fibres.npy',fibres)
np.save(root+'stimuli/drosophila_optic_stimulus.npy',stimulus)
